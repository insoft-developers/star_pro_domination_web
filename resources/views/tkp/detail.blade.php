 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">TKP</a></li>
        <li><a href="{{ url('tkp') }}">TKP</a></li>
        <li class="active">TKP Detail</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body" style="margin-top:10px">
              ...
              <table id="tkp_detail_table" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th width="5%">ID</th>
    ...
    <!-- /.content -->
    @include('modal.modal_add_tkp_detail')
