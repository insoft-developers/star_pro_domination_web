     ...
     <div class="content-wrapper">
         ...
         <section class="content-header">
             ...
             <ol class="breadcrumb">
                 ...
                 <li><a href="#">TKA</a></li>
                 <li><a href="{{ url('tka_session') }}">TKA Session</a></li>
                 <li class="active">{{ $tka->judul }}</li>
             </ol>
         </section>
                 ...
                 <div class="col-xs-12">
                     ...
                     <div class="box">
                         <div class="box-header">
                             <h3 class="box-title">{{ $tka->judul ?? '' }}</h3>
                             <button style="float: right;" class="btn btn-danger" id="btn_delete_selected" disabled>
                         ...
                         <div class="box-body" style="margin-top:10px">
                             <div class="table-responsive">
                                 <table style="font-size:13px;" id="tka_session_detail_table"
