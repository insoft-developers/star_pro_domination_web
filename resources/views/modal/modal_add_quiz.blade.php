            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <span id="soal-kuis-latex-container" style="display: none;">
                            <math-field id="mf-soal_kuis" virtual-keyboard-mode="off"></math-field>
                            <button onclick="insertEquation('mf-soal_kuis','soal_kuis')" type="button" style="margin-bottom: 5px;" class="btn btn-success btn-sm">Insert Equation</button>

                            <button onclick="clearEquation('mf-soal_kuis')" type="button" style="margin-bottom: 5px;" class="btn btn-warning btn-sm">Clear</button>

                            <button id="btn-hide-soal-kuis-latex-container" onclick="hideEquation('soal-kuis-latex-container')" type="button" style="margin-bottom: 5px;float:right;" class="btn btn-danger btn-sm">Hide Equation</button>
                        </span>

                        <div>
                            <button id="btn-show-soal-kuis-latex-container" onclick="showEquation('soal-kuis-latex-container')" type="button" style="margin-bottom: 5px;" class="btn btn-info btn-sm">Show Equation</button>
                        ...
                        <label>Soal lanjutan dibawah gambar (Opsional)</label>
