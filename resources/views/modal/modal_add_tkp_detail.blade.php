  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="hidden" id="id_tkp" name="id_tkp" value="{{ $tkp->id }}">
          <div class="row">
              <div class="col-md-12">
                     ...
                     <div class="box-body">
                         <div class="form-group">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              <label>Score A</label>
                              <textarea class="form-control" id="score_a" name="score_a" required></textarea>
                          </div>
                     </div>
                 </div>
                 ...
                 <div class="box box-danger">
                     <div class="box-body">
                         <div class="form-group">
                          ...
                          <div class="form-group">
                              <label>Score B</label>
                              <textarea class="form-control" id="score_b" name="score_b" required></textarea>
                          </div>
                     </div>
                 </div>
                 ...
                 <div class="box box-danger">
                     <div class="box-body">
                          ...
                          <div class="form-group">
                              <label>Score C</label>
                              <textarea class="form-control" id="score_c" name="score_c" required></textarea>
                          </div>
                 ...
                 <div class="box box-danger">
                     <div class="box-body">
                          ...
                          <div class="form-group">
                              <label>Score D</label>
                              <textarea class="form-control" id="score_d" name="score_d" required></textarea>
                          </div>
                     </div>
                 </div>
                 ...
                 <div class="box box-danger">
                     <div class="box-body">
                          ...
                          <div class="form-group">
                              <label>Score E</label>
                              <textarea class="form-control" id="score_e" name="score_e" required></textarea>
                          </div>
                     </div>
                 </div>
