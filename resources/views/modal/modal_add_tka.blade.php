                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Kelas</label>
                                <select style="width:100%;" class="form-control" id="id_kelas" name="id_kelas[]"
                                    multiple required>
                    ...
                    <div class="row" style="margin-top:15px;">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group my-colorpicker2">
                                    <input type="text" class="form-control" id="warna_soal" name="warna_soal"
                                        required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group my-colorpicker2">
                                    <input type="text" class="form-control" id="warna_tulisan" name="warna_tulisan"
                                        required>
                                    <div class="input-group-addon">
                                        <i></i>
                                    </div>
                    ...
                    <div class="row" style="margin-top:15px;">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group my-colorpicker2">
                                    <input type="text" class="form-control" id="warna_jawaban" name="warna_jawaban"
                                        required>
                                    <div class="input-group-addon">
                                        <i></i>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group my-colorpicker2">
                                    <input type="text" class="form-control" id="warna_tulisan_jawaban"
                                        name="warna_tulisan_jawaban" required>
                                    <div class="input-group-addon">
                                        <i></i>
                                    </div>
                                </div>
