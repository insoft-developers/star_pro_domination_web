    ...
    public function examTable($id)
    {
        ...
        return Datatables::of($exam)
            ...
            ->addColumn('detail', function ($exam) {
                $button = '';
                $button .= '<center>';
                $button .= '<a onclick="listData(' . $exam->id . ')" style="width:25px;" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list"></i></a>';
                $button .= '<a onclick="deleteDataSession(' . $exam->id . ')" style="width:25px;margin-top:5px;" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>';
                $button .= '</center>';
                return $button;
    ...
    public function sessionTable()
    {
        ...
        return Datatables::of($tryout)
            ...
            ->addColumn('action', function ($tryout) {
                $button = '';
                $button .= '<center>';
                $button .= '<a onclick="listData(' . $tryout->id . ')" style="width:25px;margin-right:5px;" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list"></i></a>';
